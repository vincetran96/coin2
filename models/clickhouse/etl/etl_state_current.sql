...
(
    ...
    last_src_change_tstamp     DateTime64(6, 'UTC'),                           -- The last value of the audit column _change_tstamp in this ETL run
    
    -- Audit columns
    _change_tstamp             DateTime64(6, 'UTC') DEFAULT now64(6, 'UTC'),   -- Insert timestamp of this record into this table
)
ENGINE = ReplacingMergeTree(_change_tstamp)
PARTITION BY toYYYYMMDD(_change_tstamp)
ORDER BY (job_name)
;
